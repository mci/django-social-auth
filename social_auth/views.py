...
def disconnect(request, backend, association_id=None):
    ...
    url = request.GET.get(REDIRECT_FIELD_NAME, request.POST.get(REDIRECT_FIELD_NAME, '')) or \
...
def complete_process(request, backend, *args, **kwargs):
    ...
    redirect_value = request.session.get(REDIRECT_FIELD_NAME, '') or \
                     request.GET.get(REDIRECT_FIELD_NAME, request.POST.get(REDIRECT_FIELD_NAME, ''))
